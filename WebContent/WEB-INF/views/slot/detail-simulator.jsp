                ...
                <div class="col-lg-6">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                               ...
                               <div class="row">
                                   <label class="col col-lg-3">라인 지급률(%)</label>
                                   <div class="col col-lg-3 text-right">${func:formatPercent(result.linePayoutRate)}</div>
                                   <label class="col col-lg-3" >라인  승률(%)</label>
                                   <div class="col col-lg-3 text-right" >${func:formatPercent(result.winLineRate)}</div>
                               </div>
                               
                               <div class="row">
                                   <label class="col col-lg-3">scatter 지급률(%)</label>
                                   <div class="col col-lg-3 text-right">${func:formatPercent(result.scatterPayoutRate)}</div>
                                   <label class="col col-lg-3" >scatter 승률(%)</label>
                                   <div class="col col-lg-3 text-right" >${func:formatPercent(result.winScatterRate)}</div>
                               </div>
                               
                               <div class="row">
                                   <label class="col col-lg-3">bonus 지급률(%)</label>
                                   <div class="col col-lg-3 text-right">${func:formatPercent(result.scatterBonusPayoutRate)}</div>
                                   <label class="col col-lg-3" >bonus 승률(%)</label>
                                   <div class="col col-lg-3 text-right" >${func:formatPercent(result.winScatterBonusRate)}</div>
                               </div>
                               
                               <div class="row">
                                   <label class="col col-lg-3" >freespin 지급률(%)</label>
                                   <div class="col col-lg-3 text-right" >${func:formatPercent(result.scatterFreespinPayoutRate)}</div>
                                   <label class="col col-lg-3">freespin 승률(%)</label>
                                   <div class="col col-lg-3 text-right">${func:formatPercent(result.winScatterFreespinRate)}</div>
                               </div>
