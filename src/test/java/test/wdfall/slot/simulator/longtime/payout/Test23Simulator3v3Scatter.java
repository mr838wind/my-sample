 ...
 */
@Slf4j
public class Test23Simulator3v3Scatter {

	@Test
	public void testSpin() throws Exception{
		
		double EXCEL_EXPECTED_PAYOUT = 1.450805664;
		
		//GameProperties prop = TestUtils.makeGameProperties3v3Scatter();
		GameProperty prop = GamePropertyUtils.makeGameProperties3v3ScatterExcel();
		//10*1000*1000*1000
